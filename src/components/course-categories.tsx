      ...
      <div className="container">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground mt-2">
            Explore our diverse range of courses and find the right path for
            your career
          </p>
        </div>
        ...
        <Tabs defaultValue="paramedical" className="w-full">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {category.courses.map((course, index) => (
                      <div
                        key={index}
                        className="p-3 rounded-md border bg-blue-50 hover:bg-blue-100 transition-colors"
                      >
                        {course}
                      </div>
                    ))}
